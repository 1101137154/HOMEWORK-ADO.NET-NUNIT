...
<body>
    ...
    <div>
        ...
        Location:<asp:TextBox ID="txtAge" runat="server"></asp:TextBox>
        Manager:<asp:TextBox ID="txtMan" runat="server"></asp:TextBox>
        ...
        Location:<asp:TextBox ID="txtE_Age" runat="server"></asp:TextBox>
        Manager:<asp:TextBox ID="txtE_Man" runat="server"></asp:TextBox>
